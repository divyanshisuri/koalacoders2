...
def model_builder():
    ...
    u1 = Users(name='Ally L.', email='allyle@example.com', password='hdfhudg7', phone="7367837654")
    ...
    for row in table:
        ...
        try:
            ...
            pass
        shutil.copy("../static/collegelife.PNG", "../volumes/uploads")
        # add some notes with default image
        try:
            '''add a few 1 to 4 notes per user'''
            for num in range(randrange(1, 4)):
                note = "#### " + row.name + " note " + str(num) + ". \n Generated by test data."
                row.notes.append(Notes(userID=row.userID, note=note, image='/static/collegelife.PNG'))
